...
- IP-pohjaiset palvelimet tunnistetaan laitteen IP-osoitteen perusteella.
  
- Nimipohjaiset palvelimet käyttävät verkkotunnuksia. Verkkotunnuksia käytetään IP-osoitteen sijaan, kun  asiakas (client) lähettää pyynnön.
  
- Palvelin tarkistaa IP-osoitteen ja portin saatuaan pyynnön. Jos palvelimia on usempia - vertaa Apache pyynnön palvelinnimeä (ServerName -ja ServerAlias) valiten oikean.

**Name Based Virtual Hosts on Apache – Multiple Websites to Single IP Address**
   
- Artikkelissa kerrotaan, että Apachella voi käyttää useampaa verkkotunnusta yhtä IP-osoitetta käyttäen.
  
- Siellä opetetaan myös lisäämään uusi nimipohjainen palvelin, web-palvelimen asennus ja määrittely, tarkistus, sekä verkkosivun luonti ilman sudo-oikeuksia. 
